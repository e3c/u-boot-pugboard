...
#define MUX_BEAGLE() \
 ...
 /*LED Camera */\
	MUX_VAL(CP(MMC2_CLK),		(IDIS | PTD | DIS | M4)) /*GPIO_130*/\
 /*Wireless LAN */\
 ...
 /*Control and debug */\
	...
	MUX_VAL(CP(ETK_D0_ES2),		(IDIS | PTD | DIS | M4)) /*HSUSB1_DATA0*/\
	...
	MUX_VAL(CP(ETK_D8_ES2),		(IDIS | PTD | DIS | M4)) /*HSUSB1_DIR*/\
	MUX_VAL(CP(ETK_D9_ES2),		(IDIS | PTD | DIS | M4)) /*HSUSB1_NXT*/\
