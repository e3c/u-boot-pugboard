...
#define MUX_BEAGLE() \
 ...
 /*GPMC*/\
	...
	MUX_VAL(CP(GPMC_NCS6),		(IDIS | PTD | DIS | M4)) /*SYS_nDMA_REQ2*/\
 ...
 /*LED Camera */\
	MUX_VAL(CP(MMC2_CLK),		(IEN | PTD | DIS | M4)) /*GPIO_130*/\
 /*Wireless LAN */\
 ...
 /*LCD */\
	MUX_VAL(CP(MCBSP3_DX),		(IDIS | PTD | DIS | M4)) /*UART2_CTS*/\
	MUX_VAL(CP(MCBSP3_DR),		(IDIS | PTD | DIS | M4)) /*UART2_RTS*/\
	MUX_VAL(CP(MCBSP3_CLKX),	(IDIS | PTD | DIS | M4)) /*UART2_TX*/\
	MUX_VAL(CP(MCBSP3_FSX),		(IDIS | PTD | DIS | M4)) /*UART2_RX*/\
 ...
 /*Serial Interface*/\
	...
	MUX_VAL(CP(HDQ_SIO),		(IEN | PTU | EN  | M4)) /*GPIO_170*/\
 ...
 /*Control and debug */\
	...
	MUX_VAL(CP(ETK_CLK_ES2),	(IEN | PTU | EN  | M2)) /*HSUSB1_STP*/\
	MUX_VAL(CP(ETK_CTL_ES2),	(IEN | PTU | EN | M2)) /*HSUSB1_CLK*/\
	MUX_VAL(CP(ETK_D0_ES2),		(IEN | PTD | DIS | M4)) /*HSUSB1_DATA0*/\
	MUX_VAL(CP(ETK_D1_ES2),		(IDIS | PTD | DIS | M4)) /*HSUSB1_DATA1*/\
	MUX_VAL(CP(ETK_D2_ES2),		(IDIS | PTD | DIS | M4)) /*HSUSB1_DATA2*/\
	MUX_VAL(CP(ETK_D3_ES2),		(IEN  | PTU | DIS | M2)) /*HSUSB1_DATA7*/\
	MUX_VAL(CP(ETK_D4_ES2),		(IEN  | PTU | DIS | M2)) /*HSUSB1_DATA4*/\
	MUX_VAL(CP(ETK_D5_ES2),		(IEN  | PTU | DIS | M2)) /*HSUSB1_DATA5*/\
	MUX_VAL(CP(ETK_D6_ES2),		(IEN  | PTU | DIS | M2)) /*HSUSB1_DATA6*/\
	MUX_VAL(CP(ETK_D7_ES2),		(IEN  | PTU | DIS | M4)) /*HSUSB1_DATA3*/\
	MUX_VAL(CP(ETK_D8_ES2),		(IEN | PTD | DIS | M4)) /*HSUSB1_DIR*/\
	MUX_VAL(CP(ETK_D9_ES2),		(IEN | PTD | DIS | M4)) /*HSUSB1_NXT*/\
...
#define MUX_BEAGLE_XM() \
	...
	MUX_VAL(CP(UART2_CTS),		(IDIS | PTD | DIS | M4)) /*UART2_CTS*/\
	MUX_VAL(CP(UART2_RTS),		(IDIS | PTD | DIS | M4)) /*UART2_RTS*/\
	MUX_VAL(CP(UART2_TX),		(IDIS | PTD | DIS | M4)) /*UART2_TX*/\
